...
const LostRoute = () => (
  <div
    className="relative mx-auto h-36 w-full max-w-[360px]"
    aria-hidden="true"
  >
    <svg
      viewBox="0 0 320 140"
  ...
  return (
    <Section tone="canvas" bordered={false} innerClassName="relative">
      ...
      <Reveal className="relative mx-auto flex max-w-3xl flex-col items-center gap-6 py-[clamp(20px,5vw,48px)] text-center">
        ...
        <h1 className={`${sectionTitleClass} font-display`}>
          This one never made it to your door.
        </h1>
        <p className="max-w-[52ch] text-[clamp(15px,1.2vw,18px)] leading-[1.6] text-ink/68 font-display">
          We checked every duka on the route and couldn't find the page
          you're after — it may have moved, changed its name, or never
          stocked here in the first place.
        </p>
